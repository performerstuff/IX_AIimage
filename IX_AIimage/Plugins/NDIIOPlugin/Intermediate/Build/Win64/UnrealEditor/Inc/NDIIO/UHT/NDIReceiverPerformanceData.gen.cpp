...
template<> NDIIO_API UScriptStruct* StaticStruct<FNDIReceiverPerformanceData>()
{
	...
	struct Z_CompiledInDeferFile_FID_XrLive_Launcher_Plugins_NDIIOPlugin_Source_Core_Public_Structures_NDIReceiverPerformanceData_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_XrLive_Launcher_Plugins_NDIIOPlugin_Source_Core_Public_Structures_NDIReceiverPerformanceData_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_XrLive_Launcher_Plugins_NDIIOPlugin_Source_Core_Public_Structures_NDIReceiverPerformanceData_h_2125905718(TEXT("/Script/NDIIO"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_XrLive_Launcher_Plugins_NDIIOPlugin_Source_Core_Public_Structures_NDIReceiverPerformanceData_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_XrLive_Launcher_Plugins_NDIIOPlugin_Source_Core_Public_Structures_NDIReceiverPerformanceData_h_Statics::ScriptStructInfo),
		nullptr, 0);
