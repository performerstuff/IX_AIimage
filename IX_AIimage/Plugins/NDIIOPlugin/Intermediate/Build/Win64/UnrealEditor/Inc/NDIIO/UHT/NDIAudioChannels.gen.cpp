...
#include "Core/Public/Enumerations/NDIAudioChannels.h"
...
// End Cross Module References
	...
	static UEnum* ENDIAudioChannels_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ENDIAudioChannels.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_NDIIO_ENDIAudioChannels, Z_Construct_UPackage__Script_NDIIO(), TEXT("ENDIAudioChannels"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_NDIIO_ENDIAudioChannels_Statics::EnumParams = {
		...
		METADATA_PARAMS(Z_Construct_UEnum_NDIIO_ENDIAudioChannels_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_NDIIO_ENDIAudioChannels_Statics::Enum_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_XrLive_Launcher_Plugins_NDIIOPlugin_Source_Core_Public_Enumerations_NDIAudioChannels_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_XrLive_Launcher_Plugins_NDIIOPlugin_Source_Core_Public_Enumerations_NDIAudioChannels_h_Statics::EnumInfo[] = {
		{ ENDIAudioChannels_StaticEnum, TEXT("ENDIAudioChannels"), &Z_Registration_Info_UEnum_ENDIAudioChannels, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 362666679U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_XrLive_Launcher_Plugins_NDIIOPlugin_Source_Core_Public_Enumerations_NDIAudioChannels_h_3506655824(TEXT("/Script/NDIIO"),
		nullptr, 0,
		nullptr, 0,
		Z_CompiledInDeferFile_FID_XrLive_Launcher_Plugins_NDIIOPlugin_Source_Core_Public_Enumerations_NDIAudioChannels_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_XrLive_Launcher_Plugins_NDIIOPlugin_Source_Core_Public_Enumerations_NDIAudioChannels_h_Statics::EnumInfo));
