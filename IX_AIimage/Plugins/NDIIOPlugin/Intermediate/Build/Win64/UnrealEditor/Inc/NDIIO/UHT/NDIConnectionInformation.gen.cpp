...
template<> NDIIO_API UScriptStruct* StaticStruct<FNDIConnectionInformation>()
{
	...
	struct Z_CompiledInDeferFile_FID_XrLive_Launcher_Plugins_NDIIOPlugin_Source_Core_Public_Structures_NDIConnectionInformation_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_XrLive_Launcher_Plugins_NDIIOPlugin_Source_Core_Public_Structures_NDIConnectionInformation_h_Statics::ScriptStructInfo[] = {
		{ FNDIConnectionInformation::StaticStruct, Z_Construct_UScriptStruct_FNDIConnectionInformation_Statics::NewStructOps, TEXT("NDIConnectionInformation"), &Z_Registration_Info_UScriptStruct_NDIConnectionInformation, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNDIConnectionInformation), 671100022U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_XrLive_Launcher_Plugins_NDIIOPlugin_Source_Core_Public_Structures_NDIConnectionInformation_h_3339602281(TEXT("/Script/NDIIO"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_XrLive_Launcher_Plugins_NDIIOPlugin_Source_Core_Public_Structures_NDIConnectionInformation_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_XrLive_Launcher_Plugins_NDIIOPlugin_Source_Core_Public_Structures_NDIConnectionInformation_h_Statics::ScriptStructInfo),
		nullptr, 0);
