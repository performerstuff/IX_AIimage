...
template<> NDIIO_API UScriptStruct* StaticStruct<FTriCasterExt>()
{
	...
	struct Z_CompiledInDeferFile_FID_IX_AIimage_Plugins_NDIIOPlugin_Source_Core_Public_Components_NDITriCasterExtComponent_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_IX_AIimage_Plugins_NDIIOPlugin_Source_Core_Public_Components_NDITriCasterExtComponent_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_IX_AIimage_Plugins_NDIIOPlugin_Source_Core_Public_Components_NDITriCasterExtComponent_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_IX_AIimage_Plugins_NDIIOPlugin_Source_Core_Public_Components_NDITriCasterExtComponent_h_2484704057(TEXT("/Script/NDIIO"),
		Z_CompiledInDeferFile_FID_IX_AIimage_Plugins_NDIIOPlugin_Source_Core_Public_Components_NDITriCasterExtComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_IX_AIimage_Plugins_NDIIOPlugin_Source_Core_Public_Components_NDITriCasterExtComponent_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_IX_AIimage_Plugins_NDIIOPlugin_Source_Core_Public_Components_NDITriCasterExtComponent_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_IX_AIimage_Plugins_NDIIOPlugin_Source_Core_Public_Components_NDITriCasterExtComponent_h_Statics::ScriptStructInfo),
		nullptr, 0);
